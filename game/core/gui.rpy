...
## 游戏内文本使用的字体。
define gui.text_font = "fonts/genshin.ttf"

## 角色名称使用的字体。
define gui.name_text_font = "fonts/genshin.ttf"

## 游戏外文本使用的字体。
define gui.interface_text_font = "fonts/genshin.ttf"
...
define gui.game_menu_background = Image("gui/game_menu.png")
...
define gui.history_name_xpos = 223
...
init python:
    ...
    def small():
        ...
        gui.history_height = 500
        gui.history_text_width = 1335
