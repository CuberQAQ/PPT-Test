...
transform ease_up:
    yoffset 80.0
    easein 1.5 yoffset 0.0

transform EaseUp(delay=0, t=1.5):
    yoffset 80.0
    pause delay
    easein t yoffset 0.0
...
screen main_menu():
    ...
    ## 此语句可确保替换掉任何其他菜单屏幕。
    tag menu
    add gui.main_menu_background at img_wandering
    add Solid("#000") at fadeout
...
烛火与战火
    ...
    """) at ease_up, fadein:    
        ...
        color "#f3f3f3f3"
        outlines [ (2,"#333333") ]
    text _("高二A B班     指导老师: 周英") at EaseUp(.1), fadein:
        xalign 0.5
        yalign 0.55
        size 50
        text_align 0.5
        color "#e3e3e3e3"
        outlines [ (2,"#333333") ]
    textbutton _("Start") at fadein action Start():
        xalign 0.5
        yalign 0.92
        text_size 60
        text_color "#eeeeeeee"
...
style nvl_frame is gui_frame

style nvl_frame:
    background Frame("gui/nvl_frame.png", Borders(60,60,60,60), tile=gui.frame_tile)
    padding gui.confirm_frame_borders.padding
    xalign .5
    yalign .5 
