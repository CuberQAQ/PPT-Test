...
define palestinian_ambassador= Character("Palestinian Ambassador ", kind = nvl, who_suffix="\n巴勒斯坦驻联合国大使")
...
label speaking:
    ...
    voice "audio/voice/narrator/speaking_1.mp3"
    narrator"The scene switched to the White House.
\n\n场景转到了美国白宫。"
    nvl clear

    voice "audio/voice/american_officer/speaking_1.mp3"
...
\n\n不可否认，哈马斯率先发动了袭击，以色列有权自卫，有权反击，这一切都是为了捍卫以色列人民的人权，他们拥有人权。"
    ...
    voice "audio/voice/narrator/speaking_2.mp3"
...
\n\n场景转到了联合国"
    ...
    voice "audio/voice/palestinian_ambassador/speaking_1.mp3"
    palestinian_ambassador"Aid workers were targeted and killed, Rescue teams are struggling to carry out their missions and continued with earth strikes. There is a severe shortage of rescue equipment, limited or no mobile Internet connection, there‘s no power, no water, no fuel.
\n\n救援人员成为袭击目标并被杀害，救援队正在努力执行他们的任务，并继续进行地面打击。救援设备严重短缺，有限或没有移动互联网连接，没有电，没有水，没有燃料。"
    nvl clear

    voice "audio/voice/palestinian_ambassador/speaking_2.mp3"
    palestinian_ambassador"Food supplies are running dangerous below, hospitals are over with the patients and injured by running out of medicines. Morgues are overflowing with bodies.
\n\n食物供应正在危险地运行,医院挤满了病人和因药品耗尽而受伤的人,停尸房里堆满了尸体。"
    ...
    voice "audio/voice/narrator/speaking_3.mp3"
    narrator"The scene switched to ministry of foreign affairs of China.
\n\n场景转到了中国外交部。"
    nvl clear

    voice "audio/voice/chinese_diplomatist/speaking_1.mp3"
...
\n\n各位朋友们，近日，加沙地带一医院遭遇空袭，超500人伤亡。巴以突不断升级，中方愿同世界各国一道，推动尽快停止战火，防止局势进一步升级甚至失控。"
    ...
    voice "audio/voice/chinese_diplomatist/speaking_2.mp3"
